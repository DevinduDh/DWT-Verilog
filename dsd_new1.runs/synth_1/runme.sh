...
HD_PWD='C:/Users/3ddev/Documents/1st sem-Mtech/Digital System Design/Project/dsd_new1/dsd_new1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rpUnit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rpUnit.tcl
